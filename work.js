	...
	createApp({
		setup() {
			...
			(() => {
				...
				const sessionId = localStorage.getItem("SessionId");
				if (!rid) {
					window.location = "work-room-select.html";
					return;
				}
			...
			return window.d = {
				...
				speechRecognitionAvailable, geminiApiKey, firstSent, gasUserId, roomId, roomName, roomGot, roomError,
				renameRoom, renamingRoom, updateLastVoice,
			};
		},
	}).mount("#app");
})();
