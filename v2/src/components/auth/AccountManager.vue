	...
	<div class="p-6 max-w-md mx-auto">
			...
			<div>
				...
				<form @submit.prevent="dologin.exec" class="space-y-4">
					...
					<p class="text-red-500 text-sm">
						<LoadingIndicator :show="dologin.trying" />
						{{ dologin.error }}
					</p>
				</form>
			</div>
			...
			<form @submit.prevent="mkaccount.exec" class="space-y-4">
				...
				<label class="block">
					...
					<input
						type="password"
						class="mt-1 w-full border border-gray-300 rounded px-3 py-2"
						v-model="mkaccount.passwordConfirm"
						:readonly="someTrying"
					/>
				</label>
				...
				/>
				<p class="text-red-500 text-sm">
					<LoadingIndicator :show="mkaccount.trying" />
					{{ mkaccount.error }}
				</p>
			</form>
		</div>
		...
		<div v-else class="space-y-4">
			...
			<form @submit.prevent="dologout.exec">
				...
				/>
				<p class="text-red-500 text-sm">
					<LoadingIndicator :show="dologout.trying" />
					{{ dologout.error }}
				</p>
			</form>
		</div>
