<template>
	<div class="px-4 py-6 text-center">
		...
		<p class="mb-6 text-neutral-600">
			お疲れさまでした。以下があなたの結果です。
		</p>

		<!-- スコアカード -->
		<div
			class="mx-auto mb-6 w-full max-w-sm rounded-xl border border-neutral-200 bg-white p-6 shadow"
		>
	...
	<!-- ナビゲーション -->
	<div
		class="fixed bottom-0 z-50 w-full border-t-2 border-neutral-200 bg-white shadow-md"
	>
